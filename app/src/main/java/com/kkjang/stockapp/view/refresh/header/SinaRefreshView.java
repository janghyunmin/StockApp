package com.kkjang.stockapp.view.refresh.header;
...
import com.kkjang.stockapp.view.refresh.IHeaderView;
import com.kkjang.stockapp.view.refresh.OnAnimEndListener;
...
public class SinaRefreshView extends FrameLayout implements com.lcodecore.tkrefreshlayout.IHeaderView {
...
//    private String pullDownStr = "새로고침 입니다.";
    ...
    private String releaseRefreshStr = "그만땡겨주세요 ㅜㅜ..";
    private String refreshingStr = "데이터를 불러오는중입니다.";
    ...
    public void onPullingDown(float fraction, float maxHeadHeight, float headHeight) {
        ...
        if (fraction > 2f) refreshTextView.setText(releaseRefreshStr);
    ...
    @Override
    public void onFinish(com.lcodecore.tkrefreshlayout.OnAnimEndListener animEndListener) {
