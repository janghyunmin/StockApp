package com.kkjang.stockapp.view.refresh;
...
import com.kkjang.stockapp.view.refresh.Footer.BallPulseView;
import com.kkjang.stockapp.view.refresh.header.GoogleDotView;
import com.kkjang.stockapp.view.refresh.processor.AnimProcessor;
import com.kkjang.stockapp.view.refresh.processor.IDecorator;
import com.kkjang.stockapp.view.refresh.processor.OverScrollDecorator;
import com.kkjang.stockapp.view.refresh.processor.RefreshProcessor;
import com.kkjang.stockapp.view.refresh.utils.DensityUtil;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mMaxHeadHeight = 1200;
//            mMaxHeadHeight = a.getDimensionPixelSize(R.styleable.BottomBar_bb_activeTabAlpha, (int) DensityUtil.dp2px(context, 120));
            mHeadHeight = a.getDimensionPixelSize(R.styleable.BottomBar_bb_activeTabAlpha, (int) DensityUtil.dp2px(context, 80));
            mMaxBottomHeight = a.getDimensionPixelSize(R.styleable.BottomBar_bb_activeTabAlpha, (int) DensityUtil.dp2px(context, 120));
            mBottomHeight = a.getDimensionPixelSize(R.styleable.BottomBar_bb_activeTabAlpha, (int) DensityUtil.dp2px(context, 60));
            mOverScrollHeight = a.getDimensionPixelSize(R.styleable.BottomBar_bb_activeTabAlpha, (int) mHeadHeight);
            enableRefresh = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            enableLoadmore = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            isPureScrollModeOn = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, false);
            isOverScrollTopShow = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            isOverScrollBottomShow = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            enableOverScroll = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            floatRefresh = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, false);
            autoLoadMore = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, false);
            enableKeepIView = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            showRefreshingWhenOverScroll = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
            showLoadingWhenOverScroll = a.getBoolean(R.styleable.BottomBar_bb_activeTabAlpha, true);
        } finally {
            a.recycle();
        }
